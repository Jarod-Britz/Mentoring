...
@Component({
  selector: 'app-chicken-salad',
  templateUrl: './chicken-salad.component.html',
  styleUrls: ['./chicken-salad.component.css']
})
export class ChickenSaladComponent implements OnInit {
